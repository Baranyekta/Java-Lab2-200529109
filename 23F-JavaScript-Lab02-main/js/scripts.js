    ...
    //parameter (red, green, or blue) (https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/switch)
        switch (channel) {
            case "red":
                rgb[0] = parseInt(value); // STEP 3: Updating the appropriate global rgb array element
                break;
            case "green":
                rgb[1] = parseInt(value); // STEP 3: Updating the appropriate global rgb array element
                break;
            case "blue":
                rgb[2] = parseInt(value); // STEP 3: Updating the appropriate global rgb array element
                break;
        }
        return rgb; // STEP 4: Return the updated rgb array back to the event handler
    }
